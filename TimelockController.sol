...
contract TimelockController is AccessControl {
    ...
    function executeSet(
        ...
        _beforeCall(predecessor);
        _pool.set(_withUpdate, _pid, _allocPoint, _bonusPoint, _frozenPeriod);
        _afterCall(id);
    }
    ...
    function add(
        ...
        _pool.add(_withUpdate, _isOnlyStake, 0, 0, _frozenPeriod, _want, _strat); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
